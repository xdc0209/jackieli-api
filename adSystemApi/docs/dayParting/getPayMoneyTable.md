...
## URL
> [http:// 192.168.10.168:8081/ad/dayParting/getPayMoneyTable.do](http://dataviewer.ilongyuan.com.cn/ad/dayParting/getPayMoneyTable.do)
...
|:-----   |:----|:-----------------------------    |
| dh    |  |时间段|
|diffPayMoney|  |对比日付费总额|
|selectPayMoney|  |查询日付费总额|

## 返回字段（活动对比）
> |返回字段|示例|说明                              |
|:-----   |:----|:-----------------------------    |
| dh    |  |时间段|
|promoteKey1|  |选中对比活动/活动组id；其值为该表对应类型数值，此处为：付费总额|
|promoteKey2|  |同上|
|...|  |同上|
